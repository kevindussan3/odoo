...
class KitchenScreen(models.Model):
    ...
    pos_config_id = fields.Many2one('pos.config', string='Punto de Venta Permitido')
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('sequence', 'New') == 'New':
                vals['sequence'] = self.env['ir.sequence'].next_by_code('x_kitchen.screen') or 'New'
